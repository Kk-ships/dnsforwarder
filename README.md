...
2. **Client Routing Enabled (ENABLE_CLIENT_ROUTING=true):**
   ...
   - Clients listed in `PUBLIC_ONLY_CLIENTS` use only `PUBLIC_DNS_SERVERS`
...
PUBLIC_DNS_SERVERS=1.1.1.1:53,8.8.8.8:53
PUBLIC_ONLY_CLIENTS=192.168.1.100      # Problematic device
```
...
PUBLIC_ONLY_CLIENTS=192.168.1.100,10.0.0.50          # Testing devices
```
...
PUBLIC_ONLY_CLIENTS=10.10.2.100,10.10.2.101         # Guest network devices
```
